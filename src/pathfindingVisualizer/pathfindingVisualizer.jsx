...
import { dijkstra, getNodesInShortestPathOrderDijkstra } from "../pathfindingAlgorithms/dijkstra";
import { astar, getNodesInShortestPathOrderAstar } from "../pathfindingAlgorithms/astar";
import { breadthFirstSearch, getNodesInShortestPathOrderBFS } from "../pathfindingAlgorithms/breadthFirstSearch";
import { depthFirstSearch, getNodesInShortestPathOrderDFS } from "../pathfindingAlgorithms/depthFirstSearch";
import { randomWalk } from "../pathfindingAlgorithms/randomWalk";
import { greedyBFS, getNodesInShortestPathOrderGreedyBFS } from "../pathfindingAlgorithms/greedyBestFirstSearch";
import { bidirectionalGreedySearch, getNodesInShortestPathOrderBidirectionalGreedySearch } from "../pathfindingAlgorithms/bidirectionalGreedySearch";
        ...
        <div className={this.state.visualizingAlgorithm || this.state.generatingMaze ? "grid-visualizing" : "grid"}>
          {grid.map((row, rowId) => {
            return (
              <div key={rowId}>
                {row.map((node, nodeId) => {
                  const { row, col, isStart, isFinish, isVisited, isShortest, isWall } = node;
                  return (
                    <Node
                      key={nodeId}
                      row={row}
